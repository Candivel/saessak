...
import '../../widgets/aligns/alignments.dart';
...
class AppTextFormField extends TextFormField {
  ...
  factory AppTextFormField.signInNormal({
    Key? key,
    FocusNode? focusNode,
    required TextEditingController? controller,
    required void Function(String) onChanged,
    ...
    bool enabled = true,
      ...
      AppTextFormField(
        ...
        validator: validator,
        enabled: enabled,
        style: AppTextStyle.body2.copyWith(color: AppColor.bk),
        decoration: AppInputDecoration.create(
          hintTextStyle: hintTextStyle,
          hintText: hintText,
          errorText: errorText,
